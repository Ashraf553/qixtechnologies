        ...
        <div id="hero-overlay">
          ...
          <div className="hero-content">
            ...
            <h1 className={`hero-h1 ${animClass}`}>
              ...
              <span className="thin">Делаем сайты красиво.</span>
            </h1>
            
            <div className="hero-row">
              <p className={`hero-sub ${animClass}`}>
                Проектируем, разрабатываем и запускаем быстрые сайты и мобильные приложения. Берем на себя инженерию, чтобы вы могли расти.
              </p>
